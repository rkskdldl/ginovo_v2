...
abstract class LongPutCalculatorInterface{
  //포인트 배열 변환
...
class LongPutCalculator implements LongPutCalculatorInterface{
  static LongPutCalculator instance =  LongPutCalculator();

  static double convertWidth = 132;
  static double convertHeight = MatCalculator.convertHeight-48.w;
