...
import 'package:ginovo_result/presentation/widgets/free_mode_panel.dart';
...
class FreeResultPage extends StatefulWidget {
  const FreeResultPage({
    super.key,
  ...
  @override
  State<FreeResultPage> createState() => _FreeResultPageState();
}

class _FreeResultPageState extends State<FreeResultPage> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((e){
      setState(() {
        points =  FreeCalculator.instance.translatePoints(width: 90,height: widget.points.last.y, points: widget.points);
        skidPoints =  FreeCalculator.instance.translatePoints(width: 90,height: widget.points.last.y, points: widget.skidPoints);
        isTransPoints = true;
      });
    });
    super.initState();
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        border: Border.all(color: Color(0xffF24545),)
                                    ),
                                    child: Text("Free Mode",
                                      style: TextStyle(
                                        color: Color(0xffF24545),
                                        fontSize: 10.sp,
                                        fontWeight: FontWeight.w500,
                                      ),
                                    ),
